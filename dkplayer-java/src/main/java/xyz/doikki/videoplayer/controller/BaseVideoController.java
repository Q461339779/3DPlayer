...
public abstract class BaseVideoController extends FrameLayout
    ...
    @Override
    public void setMask(boolean masked,String flag) {
        mIsMasked = masked;
        handleMaskStateChanged(mIsMasked,flag);
    }
    ...
    private void handleMaskStateChanged(boolean isMasked,String flag) {
        for (Map.Entry<IControlComponent, Boolean> next
                : mControlComponents.entrySet()) {
            IControlComponent component = next.getKey();
            component.onMaskStateChanged(isMasked,flag);
        }
        onMaskStateChanged(isMasked,flag);
    }

    /**
     * 子类可重写此方法监听锁定状态发生改变，然后更新ui
     */
    protected void onMaskStateChanged(boolean isMasked,String flag) {
