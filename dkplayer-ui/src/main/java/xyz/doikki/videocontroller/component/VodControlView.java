...
public class VodControlView extends FrameLayout implements IControlComponent, View.OnClickListener, SeekBar.OnSeekBarChangeListener {
...

    {
        ...
        mAnthology = findViewById(R.id.tv_play_anthology);
        mResolution = findViewById(R.id.tv_play_definition);
        mSpeed = findViewById(R.id.tv_play_speed);
    ...
    public void onClick(View v) {
        ...
        } else if (id == R.id.tv_play_anthology) {//选集
            mControlWrapper.toggleMaskState("anthology");
        } else if (id == R.id.tv_play_speed) {//倍速
            mControlWrapper.toggleMaskState("speed");
        }else if (id == R.id.tv_play_definition) {//倍速
            mControlWrapper.toggleMaskState("Resolution");
        }
    }
